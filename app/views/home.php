...
<div class="container">
  ...
  <div class="card">
    ...
    <div style="margin: 20px 0; padding: 20px; background: #f9f9f9; border-radius: 8px;">
      ...
      <form method="get" action="/objects/search" style="display: grid; grid-template-columns: 1fr 1fr auto; gap: 15px; align-items: end;">
        <div>
          <label style="display: block; margin-bottom: 5px; font-weight: bold; font-size: 14px;">Titre ou description</label>
          <input type="text" name="q" placeholder="Chercher un objet..." style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; box-sizing: border-box;">
        </div>
        <div>
